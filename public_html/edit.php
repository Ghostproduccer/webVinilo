            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="/inicio sesión.html">Login</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="#">Datos cliente</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link disabled" href="#">Datos Adicionales</a>
                        </li>
                        <li class="nav-item">
